...
## Konfiguration
Ergebnisrelevante Einstellungen stehen zentral in `config.horeka.json`: `lrt_cleaning`. Pfade, Workerzahlen und fachliche Schwellen werden nicht im Slurm-Script dupliziert.
