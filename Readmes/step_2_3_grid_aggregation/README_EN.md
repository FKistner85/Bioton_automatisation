...
## Configuration
Result-relevant settings are centralised in `config.horeka.json`: `lrt_grid_aggregation`. Paths, worker counts and domain thresholds are not duplicated in Slurm scripts.
