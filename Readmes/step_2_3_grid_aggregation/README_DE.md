...
## Konfiguration
Ergebnisrelevante Einstellungen stehen zentral in `config.horeka.json`: `lrt_grid_aggregation`. Pfade, Workerzahlen und fachliche Schwellen werden nicht im Slurm-Script dupliziert.
