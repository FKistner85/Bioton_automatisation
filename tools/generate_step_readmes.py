...
STEPS = [
    ...
    },
    {
        ...
        "inputs": ["Biodiversity_data/Bundeslander/All_Bundeslander/All_Bundeslander_<suffix>.gpkg"],
        "outputs": ["outputs/step_2_variants/<suffix>/step_2_0/lrt_<suffix>.gpkg", "outputs/step_2_variants/<suffix>/step_2_0/state.json"],
    ...
    },
    {
        ...
        "inputs": ["InspireGrid/Vector_Data/grid.gpkg", "outputs/step_2_variants/<suffix>/step_2_0/lrt_<suffix>.gpkg"],
        "outputs": ["outputs/step_2_variants/<suffix>/step_2_1/*", "outputs/step_2_variants/<suffix>/step_2_1_susi_compatible/*"],
    ...
    },
    {
        ...
        "inputs": ["outputs/step_1_metadata/dawnchorus_metadata_clean.csv", "outputs/step_2_variants/<suffix>/step_2_1/LRT_Grid_Majority_<suffix>.csv"],
        "outputs": ["outputs/step_2_variants/<suffix>/step_2_2/DawnChorus_LRT_Grid_Assignment_<suffix>.csv", "outputs/step_2_variants/<suffix>/step_2_2/DawnChorus_LRT_Polygon_Matches_<suffix>.csv"],
    ...
    },
    {
        ...
        "inputs": ["outputs/step_2_variants/<suffix>/step_2_1/majority_formation_grid_<suffix>.parquet"],
        "outputs": ["outputs/step_2_variants/<suffix>/step_2_3/*.csv", "outputs/step_2_variants/<suffix>/step_2_3/state.json"],
    ...
    },
    {
        ...
        "inputs": ["outputs/step_2_variants/<suffix>/step_2_1_susi_compatible/Formation_Status_Grid_withLRTCode.parquet", "outputs/step_2_variants/<suffix>/step_2_0/lrt_<suffix>.gpkg"],
        "outputs": ["outputs/step_2_variants/<suffix>/step_2_4_susi_10m/*"],
